...
public class ShellCommandAccepter {
    ...
    @ShellMethod(value = "Delete comment from book", key = {"delete-book-comments"})
    public void deleteBookComments(long bookId) {
        bookService.deleteCommentsByBookId(bookId);
    }
}
