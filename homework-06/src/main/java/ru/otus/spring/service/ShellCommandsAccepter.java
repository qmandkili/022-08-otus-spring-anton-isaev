...
public class ShellCommandsAccepter {
    ...
    public void deleteBookGenre(long bookId, long authorId) {
        bookService.deleteBookGenre(bookId, authorId);
    }

    @ShellMethod(value = "Delete comment from book", key = {"delete-book-comment"})
    public void deleteBookComment(long bookId) {
